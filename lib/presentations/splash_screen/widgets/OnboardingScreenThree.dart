...
import '../../auth/authentication_screen/authentication_screen.dart';
            ...
            Center(
              child: CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  backgroundColor: Color(0xffCBC8D3),
                  child: CircleAvatar(
                    radius: orientation == Orientation.portrait ? 90 : 60,
                    backgroundColor: Color(0xff736C8B),
                    child: Image.asset(
